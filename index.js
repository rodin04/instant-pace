...
document.getElementById('showImpressum').addEventListener('click', function(e) {
  ...
  content.innerHTML = `
    ...
    <p>Dies ist eine private, nicht-kommerzielle Webseite.<br>
    Es werden keine personenbezogenen Daten erhoben.</p>
...
function PLOTT() {
    ...
    pro100_label.textContent = `pro/100m`;
    ...
    togle_label.textContent = `Einheiten verbergen`;
